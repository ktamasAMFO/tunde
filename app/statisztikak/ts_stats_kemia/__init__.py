...
def gen_layout() -> html.Div:
    return html.Div([
        ...
        html.Div([
            html.Div([
                dbc.Row([
                    html.H2('Szenzor statisztikák - Kémia', className='stats-edit-title'),
                ...
                html.Div([
                    html.Button(id='ts-stats-edit-refresh-kemia', children='Táblázat frissítése')
                ]),
                html.Div([
                    DataTable(
                        id='ts-stats-table-kemia',
                        columns=[
            ...
            html.Div([
                ...
                html.Div([
                    html.Button(id='ts-stats-edit-delete-kemia', children='Törlés'),
                    html.Button(id='ts-stats-edit-rerun-kemia', children='Újrafuttatás'),
                    dbc.Tooltip(
                        target='ts-stats-edit-rerun-kemia',
                    ...
                    html.Button(id='ts-stats-edit-default-kemia', children='Legyen alapértelmezett'),
                    dbc.Tooltip(
                        target='ts-stats-edit-default-kemia',
                    ...
                    html.Button(id='ts-stats-edit-change-kemia', children='Változtatás'),
                    dbc.Tooltip(
                        target='ts-stats-edit-change-kemia',
                ...
                html.Div([
                    html.Fieldset([
                        ...
                        dcc.Input(id='existing-ts-stat-id-kemia', placeholder='ID', disabled=True,
                                  className='full-width')
                    ], className='stats-fieldset col-sm-2'),
                    html.Fieldset([
                        html.Legend('Név', className='stats-legend'),
                        dcc.Input(id='existing-ts-stat-name-kemia', placeholder='Elnevezés', disabled=True,
                                  className='full-width')
                    ], className='stats-fieldset col-sm-5'),
                    html.Fieldset([
                        html.Legend('API', className='stats-legend'),
                        dcc.RadioItems(id='existing-ts-stat-api-kemia',
                    ...
                    html.Fieldset([
                        ...
                        dcc.RadioItems(id='existing-ts-stat-median_iqr-kemia',
                    ...
                    html.Fieldset([
                        ...
                        dcc.Input(id='existing-ts-stat-multiplier-iqr-kemia', placeholder='Szorzó',
                                  className='full-width')
                    ], className='stats-fieldset col-sm-2'),
                    html.Fieldset([
                        html.Legend('STD szorzó', className='stats-legend'),
                        dcc.Input(id='existing-ts-stat-multiplier-std-kemia', placeholder='Szorzó',
                                  className='full-width')
                    ], className='stats-fieldset col-sm-2'),
                    html.Fieldset([
                        html.Legend('Cikkszám/Termék', className='stats-legend'),
                        dcc.Dropdown(id='existing-ts-stat-itemnr-dropdown-kemia', placeholder='Cikkszám', disabled=True),
                        dcc.Input(id='existing-ts-stat-chosen-product-kemia', disabled=True)
                    ], className='stats-fieldset col-sm-5'),
                    html.Fieldset([
                        html.Legend('Időszakok', className='stats-legend'),
                        dcc.Checklist(id='existing-ts-stat-time-checkboxes-kemia')
                    ], className='stats-fieldset col-sm-3'),
                    html.Fieldset([
                        html.Legend('Sarzsok', className='stats-legend'),
                        dcc.Checklist(id='existing-ts-stat-charge-checkboxes-kemia',
            ...
            html.Div([
                ...
                html.Div([
                    html.Button(id='create-ts-stat-new-kemia', children='Statisztika létrehozása'),
                    html.Button(id='delete-ts-stat-new-kemia', children='Tartalom ürítése')
                ]),
                html.Div([
                    html.Div(id='alert_ts-kemia', children=[]),
                    html.Fieldset([
                        html.Legend('Név', className='stats-legend'),
                        dcc.Input(id='create-ts-stat-name-kemia', placeholder='Elnevezés', className='full-width')
                    ], className='stats-fieldset col-sm-5'),
                    html.Fieldset([
                        html.Legend('API', className='stats-legend'),
                        dcc.RadioItems(id='create-ts-stat-api-kemia',
                    ...
                    html.Fieldset([
                        html.Legend('Monitoring mérőszámok', className='stats-legend'),
                        dcc.RadioItems(id='create-ts-stat-median_iqr-kemia',
                                       className='create-stat-api',
                                       options=[{'label': 'Medián és IQR', 'value': '1'},
                                                {'label': 'Átlag és szórás', 'value': '0'}]),
                    ], className='stats-fieldset col-sm-4'),
                    html.Fieldset([
                        html.Legend('IQR szorzó', className='stats-legend'),
                        dcc.Input(id='create-ts-stat-multiplier-iqr-kemia', placeholder='Szorzó',
                                  className='full-width')
                    ], className='stats-fieldset col-sm-2'),
                    html.Fieldset([
                        html.Legend('STD szorzó', className='stats-legend'),
                        dcc.Input(id='create-ts-stat-multiplier-std-kemia', placeholder='Szorzó',
                                  className='full-width')
                    ], className='stats-fieldset col-sm-2'),
                    html.Fieldset([
                        html.Legend('Cikkszám/Termék', className='stats-legend'),
                        dcc.Dropdown(id='create-ts-stat-itemnr-dropdown-kemia', placeholder='Cikkszám'),
                        dcc.Input(id='create-ts-stat-chosen-product-kemia', disabled=True)
                    ], className='stats-fieldset col-sm-5'),
                    html.Fieldset([
                        html.Legend('Időszakok', className='stats-legend'),
                        dcc.Checklist(id='create-ts-stat-time-checkboxes-kemia')
                    ], className='stats-fieldset col-sm-3'),
                    html.Fieldset([
                        html.Legend('Sarzsok', className='stats-legend'),
                        html.Button(id='create-ts-stat-all-charges-kemia', children='Összes'),
                        dcc.Checklist(id='create-ts-stat-charge-checkboxes-kemia',
                                      className='create-stat-charge-checkboxes'),
                    ], className='stats-fieldset col-sm-10'),
